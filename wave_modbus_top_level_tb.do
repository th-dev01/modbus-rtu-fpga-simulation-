...
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_nodes[0]/slave_uart_rx/current_state}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_rx_data[0]}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_rx_valid[0]}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_rx_frame_done[0]}

add wave -noupdate -divider {5 - ESCRAVO MODBUS E CRC}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_nodes[0]/slave/state}
add wave -noupdate -radix unsigned {sim:/tb_modbus_top_level/dut/slave_nodes[0]/slave/rx_count}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_nodes[0]/slave/req_addr}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_nodes[0]/slave/req_func}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_nodes[0]/slave/req_start_addr}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_nodes[0]/slave/req_value_or_quantity}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_nodes[0]/slave/exception_code}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_crc_clear[0]}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_crc_en[0]}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_crc_data_in[0]}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_crc_out[0]}

add wave -noupdate -divider {6 - BANCO DE REGISTRADORES}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_reg_wr_en[0]}
add wave -noupdate -radix unsigned {sim:/tb_modbus_top_level/dut/slave_reg_addr[0]}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_reg_wr_data[0]}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_reg_rd_data[0]}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_reg_valid[0]}

add wave -noupdate -divider {7 - UART ESCRAVO PARA MESTRE}
add wave -noupdate -radix hexadecimal {sim:/tb_modbus_top_level/dut/slave_tx_data[0]}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_tx_valid[0]}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_tx_ready[0]}
add wave -noupdate {sim:/tb_modbus_top_level/dut/slave_nodes[0]/slave_uart_tx/state}
